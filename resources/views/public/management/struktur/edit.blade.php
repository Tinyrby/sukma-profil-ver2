...
<head>
    ...
    <title>Edit Anggota Struktur - SideS</title>
    ...
    <div class="container mt-4">
        <div class="form-container">
            ...
            <div class="form-header">
                <h3 class="mb-1">✏️ Edit Anggota Struktur</h3>
                <p class="mb-0 opacity-75">Perbarui data staf atau pejabat desa</p>
            </div>

            <!-- Form -->
            <div class="p-4">
                <form action="{{ route('public.management.struktur.update', $struktur->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="form-label">Ganti Foto Anggota</label>
                            <div class="photo-upload-area" onclick="document.getElementById('foto').click()">
                                <div id="imagePreview">
                                    ...
                                    @else
                                        ...
                                        <p class="mt-2 mb-0">Klik untuk ganti foto</p>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" {{ old('is_active', $struktur->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-save me-2"></i>Perbarui Anggota
                                    </button>
                                </div>
                            </div>
                        </div>
